...
SECRET_KEY = os.environ.get('DJANGO_TOOTHBRUSH_SECRET_KEY')
...
DOCUMENT_TYPES = ['application/pdf', 'text/plain', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document']
